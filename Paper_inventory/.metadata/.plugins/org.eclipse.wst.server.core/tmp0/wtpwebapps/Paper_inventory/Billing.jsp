							...
							<table class="table customer-table mb-0">
								...
								<tbody>
									...
									try {
										...
										String sql = "SELECT b.id AS bill_id, r.name AS retailer_name, SUM(oi.quantity) AS stock_quantity, b.amount, b.billing_date "
										+ "FROM billing b " + "JOIN orders o ON b.order_id = o.id " + "JOIN retailers r ON o.retailer_id = r.id "
										+ "JOIN order_items oi ON oi.order_id = o.id " + "GROUP BY b.id, r.name, b.amount, b.billing_date "
