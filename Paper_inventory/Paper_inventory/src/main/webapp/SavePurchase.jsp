...
%>
		<div class="alert alert-success">
			Purchase Order created successfully with ID:
			<%= purchaseOrderId %></div>
		<a href="Purchase_order.jsp" class="btn btn-primary">Create
			New Order</a>
...
%>
		<div class="alert alert-danger">
			...
			<%= e.getMessage() %></div>
		<a href="CreatePurchaseOrder.jsp" class="btn btn-primary">Try
			Again</a>
		<%
        } finally {
...
%>
    ...
    window.location.href = "Purchase_order.jsp";
</script>
	</div>
	<script
