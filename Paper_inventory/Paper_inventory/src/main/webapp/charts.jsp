<%@ page
	import="java.io.InputStream, java.util.*, java.text.SimpleDateFormat"%>
<%@ page
	import="org.apache.poi.ss.usermodel.*, org.apache.poi.xssf.usermodel.XSSFWorkbook"%>
...
<body>
	...
	<p>
		<strong>Top Selling Product of Last Year:</strong>
		<%=topProduct%></p>
	<p>
		<strong>Total Sales of This Year:</strong>
		<%=salesThisYear%></p>
	<%
	workbook.close();
	}
...
<body>
	...
	<p>
		<b>Most Selling Product Last Year:</b>
		<%=mostSellingProduct%></p>
	<p>
		<b>Total Sales Last Year:</b>
		<%=totalLastYearSales%>
		units
	</p>
	<p>
		<b>Predicted Sales for This Year:</b>
		<%=predictedSalesThisYear%>
		units
	</p>
